...
if (isset( $_SESSION['antworten']))
 {
  Print_r ($_SESSION);
  $_SESSION['antworten'][$qnumber1]=$answer;

 }
 else
 {   
   $antworten=array(); 
  $_SESSION['antworten']= $antworten;
    Print_r ($_SESSION['antworten']);
  $_SESSION['antworten'][$qnumber1]=$answer;
 }
...
$surstage = count($_SESSION['antworten']);
...
echo "<br><br><a href=\"getquestion.php?qnumber=$maxid2&asw=0\">Aller au résultat</a>";
 }
