...
echo "<center><img src=img/tunivote.jpg> </center><form action='parties.php' method='post'> Veuillez entrer votre login et mot de passe pour acc&eacute;der au questionnaire \"TuniVote\" consacr&eacute; aux partis <br>
...
echo "<form action='send.php' method='post' ><b>Vos r&eacute;ponses</b><br>
<br><br>";
...
echo "<table><tr><td></td><td><td></td></td><td><img src=yes.jpg> Pour<br><img src=no.jpg> Contre<br><img src=indiff.jpg> Neutre<br><br></td></tr><tr><td><b>Nr</b></td><td><b>R&eacute;ponse</b></td><td><b>Question</b></td><td><b>Explication</b></td></tr></b>";
...
if ($i>0)
{
echo "<tr><td><a href=\"parties.php?qnumber=$i\">$i</a></td><td><img src=$symbol ></td><td>$question</td><td>$awreason[$i]</td></tr>";
}
$i++;
$j=$i;
...
echo "</table>  <center>
<br>Veuillez entrer votre Email pour vous envoyer une confirmation de la saisie de vos r&eacute;ponses<input type=text name=email>
<br><input type=\"submit\" name=\"proceed\" value=\"Continuer\">     </center>
</form>"    ;
}
else
{
...
Veuillez r&eacute;pondre aux questions propos&eacute;es dans ce questionnaire. Sur chaque question vous pouvez entrer un commentaire explicant <br>votre position (max. 500 charact&#232;res), avant d'appuyer sur le bouton correspondant:<br><br> </center></font>";

$qnumber2=$qnumber+1;
$width=300*$qnumber/$maxid;
$width2=300;
echo "<form action=\"parties.php?qnumber=$qnumber2\" method=\"post\"><font color=666666>Question $qnumber parmi $maxid:</font> <font color=FF3333>$title</font> <br><p><font color=555555><div id=balken style=\"width: ".$width."px ; height: 5px; background-color:black; \"></div><div id=balken style=\"width: ".$width2."px ; height: 5px; background-color:red; \"></div><br><b>$question</font></b></p>  <p><b><font color=555555 size=4>$questionar<br></font></b></p>";
?>
<br>

<table><br><tr><td><font color=666666>Vous pouvez entrer votre explication ici:</font></td><td><input type="text" name="reason" size="70" MAXLENGTH="500"></td></tr></table>
</center>  <center>
<br>
...
<br>
 ...
 $j=$i+1;
 echo " <a href=\"parties.php?qnumber=$j&asw=0\">$j</a> ";


 $i++;
 }
   $i++;
echo "<br><h4><a href= \"parties.php?qnumber=$i\">Aller &#224; la vue d'ensemble</a></h4>";
echo "</center></form> ";
  }
